...
.method protected onPostExecute(Landroid/content/pm/PackageInstaller$Session;)V
    ...
    # APK fully written. Instead of committing now, hand off to the host's
    # 3s pre-commit cancel window (scheduleCommit). Button stays enabled;
    # commit + disable happen after 3s unless Cancel fires first.
    iget-object v1, p0, Lcom/android/packageinstaller/InstallInstalling$InstallingAsyncTask;->this$0:Lcom/android/packageinstaller/InstallInstalling;

    invoke-virtual {v1, p1, v0}, Lcom/android/packageinstaller/InstallInstalling;->scheduleCommit(Landroid/content/pm/PackageInstaller$Session;Landroid/content/IntentSender;)V
